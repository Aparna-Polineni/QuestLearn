...
const LEVELS = [
  ...
  { id: 3,  title: "Conditionals",   icon: "➕", part: "A" },
  { id: 4,  title: "Loops",             icon: "🔀", part: "A" },
  { id: 5,  title: "Methods",                    icon: "🔁", part: "A" },
  { id: 6,  title: "Classes",                  icon: "🔧", part: "A" },
  // Part B — Object Oriented Programming
  { id: 7,  title: "Constructors",        icon: "🏗️", part: "B" },
  { id: 8,  title: "Encapsulation",             icon: "🔨", part: "B" },
  { id: 9,  title: "Inheritance",            icon: "🔒", part: "B" },
  { id: 10, title: "Polymorphism",              icon: "🧬", part: "B" },
  { id: 11, title: "Abstract Classes",             icon: "🎭", part: "B" },
  { id: 12, title: "Interfaces",         icon: "👻", part: "B" },
  { id: 13, title: "Static vs Instance",               icon: "🔌", part: "B" },
  { id: 14, title: "Arrays & ArrayLists",       icon: "⚡", part: "B" },
