...
export default function CY2_Level13() {
  ...
  return (
    <CY2Shell levelId={13} canProceed={done}>
      <div className="cy2-intro"><h1>Level 2.13</h1><p className="cy2-why">Content placeholder — full level coming next build.</p></div>
