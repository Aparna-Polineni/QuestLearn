...
export default function DE2_Level2() {
  ...
  return (
    <DE2Shell levelId={2} canProceed={allCorrect}
      ...
      conceptReveal={[
        { label:'WHERE vs HAVING', detail:'WHERE filters rows before grouping. HAVING filters groups after aggregation. You cannot use aggregate functions in WHERE — SELECT ward_id, COUNT(*) FROM patients WHERE status="active" GROUP BY ward_id HAVING COUNT(*) > 5 filters rows first, then groups.' },
